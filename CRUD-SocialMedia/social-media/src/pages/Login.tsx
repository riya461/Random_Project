    ...
    <div  className='flex  flex-col lg:flex-row   items-center justify-center '>
      ...
      <div className="bg-white my-7 dark:bg-gray-800 p-8 rounded-lg shadow-lg w-full max-w-sm ">
        ...
        <div className="mt-6 flex items-center justify-between">
          ...
          <div className="text-sm text-gray-500 dark:text-gray-400">Or login with</div>
          <div className="w-1/3 border-b border-gray-300 dark:border-gray-600"></div>
        </div>
        ...
        <p className='mt-10 text-sm text-gray-500 hover:underline hover:cursor-pointer'><Link to="/signup">Click here first-time users</Link></p>
      </div>
